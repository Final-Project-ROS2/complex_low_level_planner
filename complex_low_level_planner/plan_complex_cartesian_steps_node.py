...
class PlanComplexCartesianSteps(Node):
    ...
    async def execute_callback(self, goal_handle):
        ...
        steps = [
            {"dx": dx, "dy": 0, "dz": 0, "r": 0, "p": 0, "y": 0},
            {"dx": 0, "dy": dy, "dz": 0, "r": 0, "p": 0, "y": 0},
            {"dx": 0, "dy": 0, "dz": dz, "r": 0, "p": 0, "y": 0},
            {"dx": 0, "dy": 0, "dz": 0, "r": droll, "p": 0, "y": 0},
            {"dx": 0, "dy": 0, "dz": 0, "r": 0, "p": dpitch, "y": 0},
            {"dx": 0, "dy": 0, "dz": 0, "r": 0, "p": 0, "y": dyaw},
        ]
